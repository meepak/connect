...
import AnimatedLogo from '../../components/svg-animation/animated-logo'
...
const Intro = () => {
  ...
  logoY.value = withTiming(100, logoConfig)
    ...
    <ScreenTemplate>
      <View style={styles.container}>
        <Animated.View
          ref={logoRef}
          style={{
            ...logoUpAnimated, width: '100%', borderWidth: 1, borderColor: 'blue',
          }}
        >
          <Text>Deepak</Text>
          {/* <AnimatedLogo play={false} /> */}
        </Animated.View>
        {/* <LottieView

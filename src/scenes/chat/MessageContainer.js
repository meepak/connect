...
import {
  Avatar, Bubble, SystemMessage, Message, MessageText,
} from 'react-native-gifted-chat'

export const renderAvatar = (props, colors) => (
  <Avatar
    {...props}
    containerStyle={{ left: { }, right: {} }}
    imageStyle={{ left: { borderWidth: 1, borderColor: colors.onBackground }, right: {} }}
  />
)

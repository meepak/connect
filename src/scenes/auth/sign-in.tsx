...
export default function Login() {
  ...
  const [email, setEmail] = useState(
    process.env.EXPO_PUBLIC_DEVELOPMENT_MODE === 'true' ? 'k@k.com' : '',
  )
  const [emailError, setEmailError] = useState('')
  const [password, setPassword] = useState(
    process.env.EXPO_PUBLIC_DEVELOPMENT_MODE === 'true' ? 'kkkkkk' : '',
  )
  ...
  return (
    ...
    >
      ...
      {/* Verification message if necessary can be displayed in Toast component */}
      ...
      <TextAndLink texts={['Log in using']} marginTop={30} marginBottom={20} />
      <SocialIcons />
